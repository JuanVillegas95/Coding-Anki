    ...
    return <React.Fragment>
                ...
                <ContainerDiv $direction="row" $gap="20px" >
                    ...
                    <ContainerDiv $direction="column" $gap="30px" >
                        <ButtonInput
                            ...
                            onClick={handleAuth}
                        />
                        <SmallTextP onClick={openWhyModal} $hover={true}>
        ...
        {isWhyModal && <ModalWrapperDiv $zIndex={1} $gap="20px"  >
            <ModalContainerDiv $width="800px" $height="800px" $padding="30px 40px" $gap="20px" $isBorder={true} >
                ...
                <ListOl $gap="10px">
                    <ListLi>
                        <u>We Never Store Your Credentials:</u> We don’t handle or store sensitive information like passwords or emails directly. Oracle securely manages all aspects of your login process, so you don’t have to worry about us storing or processing your credentials.
                    </ListLi>
                    <ListLi>
                        <u>Enterprise-Level Security:</u> Oracle's authentication system is built with advanced security protocols, ensuring that your data is protected with the same standards used by top global organizations.
                    </ListLi>
                    <ListLi>
                        <u>Convenience and Trust:</u> Using Oracle simplifies your login experience by allowing you to use their trusted authentication service, giving you peace of mind that your data is safe and secure.
                    </ListLi>
                </ListOl>
                <SmallTextP>
